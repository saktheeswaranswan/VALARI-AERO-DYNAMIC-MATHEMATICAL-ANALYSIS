...
class SlopefieldDialog(Gui.SimpleDialog):
    def __init__(self, SlopefieldItem=None):
        ...
        self.edit8 = vcl.TEdit(None, Parent = self.panel, Top = 176, Left = 150, Width = 40, Text = str(SlopefieldItem.Size) if SlopefieldItem else "1")
    ...
    def OnOk(self, sender):
        ...
        Graph.Constants ["step"] = ("100*(m+1)*(n+1)")
